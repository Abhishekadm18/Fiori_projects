		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fiorivizdemo2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorivizdemo2-display": {
								"semanticObject": "fiorivizdemo2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorivizdemo2",
									"url": sap.ui.require.toUrl("fiorivizdemo2")
								}
							}
						}
					}
